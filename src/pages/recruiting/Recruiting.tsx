  ...
  return (
    <div className="flex flex-col bg-white">
      <RecruitTopBarContainer
        TopBarContent={
          <div className="w-full max-w-[401px] mx-auto">
            ...
            {/* 스킬 */}
            <div className="mt-[11px] flex w-full px-[15px] max-w-[401px] overflow-x-scroll whitespace-nowrap scrollbar-hide">
      ...
      >
        {/* 본문 시작 */}
        <div className="px-4">
          <div className="mb-[21px] flex justify-between items-center w-full max-w-[401px] mx-auto">
            <button
