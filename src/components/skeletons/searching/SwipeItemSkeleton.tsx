    ...
    <div className={getSkeletonStyles()}>
      <div className="w-full flex flex-col gap-[8px]">
        ...
        <div className="flex justify-start items-end">
          <div className="h-6 bg-ct-gray-200 rounded w-24"></div>
          <div className="h-5 bg-ct-gray-200 rounded w-16 ml-[5px]"></div>
        </div>
        ...
        <div className="w-full flex gap-[4px] justify-start items-center flex-wrap">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="px-[9px] py-[2px] bg-ct-gray-100 rounded-[5px]">
              <div className="h-4 bg-ct-gray-200 rounded w-12"></div>
            </div>
          ))}
        </div>
        
        {/* 카드 이미지 */}
        <div className={`w-full ${getImageHeight()} bg-ct-gray-200 rounded-[8px]`}></div>
        
        {/* 한줄 소개 박스 */}
        <div className="w-full p-[12px] bg-ct-gray-100 flex flex-col rounded-[5px] gap-2">
          <div className="h-4 bg-ct-gray-200 rounded w-16"></div>
